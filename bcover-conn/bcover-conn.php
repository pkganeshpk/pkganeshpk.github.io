...
<img src="bcover-conn/Figs/PheenoCap.png"   style="border:none; height:550; width:550;"/>
</section>
...
<ul>
<li> Single line segment boundary $\Bo$ instead of multiple disks
<li> $\Bo$ has one end coloured  
<li>  Robots attach to $\Bo$ using a programmed SCS 
<div style="color:blue"> Could be just a DCS + noise  </div>  
</ul>
...
<figcaption> <small> <b>  $\Rob{2}$ and $\Rob{4}$ collide (red circles)</b> </small> </figcaption> 
</figure>
</section>
...
$\Rob{i}$ and $\Rob{j}$ inter-communicate iff $|\upos{i} - \upos{j} |  \leq \conn$
