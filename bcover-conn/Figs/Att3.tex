...
\draw[thick] (a) circle (0.25cm);
 \node[draw=none,align=left] at (-0.5,0.4) {\Large $s_1$};
...
\node[draw=none,align=left] at (0.6,0.4) {\Large $s_2$} ;
\node[draw=none,align=left] at (0.3,-0.4) {\Large $x_2$} ;
\draw[black] (0.75,0) circle (.05cm); 


\draw[thick] (c) circle (0.25cm);
\node[draw=none,align=left] at (2.0,0.4) {\Large $s_3$} ;
\node[draw=none,align=left] at (2.6,-0.4) {\Large $x_3$} ;
...
\node[draw=none,align=left] at (3.5,0.4) {\Large $s_4$} ;
